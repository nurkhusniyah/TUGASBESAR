...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 28, 2019 at 08:20 AM
...
(1243534, 'IMG_c294bb8f9f9d78ac6d912cc06964cbcb.jpg', 'Nur khusniyah', 'P', 'pekalongan', '2017-11-06', 'guru', 'Olahraga', 'Talun, pekalongan ', '534667458'),
(12345678, '20180407_093657.jpg', 'naufal H.A', 'P', 'Pekalongan', '2017-11-21', 'guru', 'IPS', 'Kajen', '43453644');
...
(4, 1, '2019-06-28', 'Kesehatan Siswa dan Guru', 'KesehatanSiswadanGuru', '20180407_093657.jpg', 'Pengabdian Kepada Masyarakat (PKM) ini berdasarkan konsep Continuum of Care untuk meningkatkan status kesehatan dimulai dari pra hamil, hamil, bersalin, nifas, bayi, balita, anak, remaja, dewasa (masa produktif) dan lansia telah didukung oleh sistem pencatatan status kesehatan standar yang disusun Kementrian Kesehatan RI. Pada masa hamil, sampai dengan balita, Kementrian Kesehatan telah mempunyai buku KIA (Kesehatan Ibu dan Anak) untuk memantau kesehatan ibu, bayi dan balita (sampai dengan usia 5 tahun) (Permenkes No. 42 tahun 2013). Masa dewasa dan lansia juga sudah terdapat sistem pencatatan standar melalui program Posbindu (Pos Pembinaan Terpadu) dan Posyandu Lansia untuk masa usia lansia. Namun catatan kesehatan usia diatas 5 tahun sampai dengan remaja masih belum terdapat acuan yang standar. Hanya catatan imunisasi boster untuk anak sekolah (BIAS/ Bulan Imunisasi Anak Sekolah) yang tercatat tergabung pada buku KIA. Indikator catatan kesehatan usia SD dan remaja masih belum standar, dan masih merupakan kebijakan lokal sekolah terkait dengan kegiatan Usaha Kesehatan Sekolah (UKS).<br>', 'ID001'),
(6, 5, '2019-06-28', 'Siswa Berprestasi sekali', 'SiswaBerprestasisekali', '20180325_154330.jpg', 'Yumna (12), lulusan SDN 02 Pekeringanalit di Pekalongan, sangat kesal. Dia membakar belasan piagam penghargaan yang telah didapatkannya selama ini. Aksinya itu didorong kekecewaan tidak diterima di sekolah SMPN 1 Kajen, Pekalongan, yang diidamkannya.&nbsp;<br><br>Aksi pembakaran belasan piagam ini dilakukan Minggu (23/6) lalu dan segera viral di media sosial. Terpukul oleh kesedihannya itu, kini bahkan dia menjadi sakit. Ketika detikcom bekunjung ke rumahnya di Griya Kajen Indah RT 4 RW 12, Gandarum, Kajen, Kabupaten Pekalongan, hanya ditemui kedua orang tuanya, Sugeng Wiyoto (50) dan Sukoharti (45).<br><br>Sugeng Wiyoto mengatakan pembakaran belasan piagam penghargaan tersebut dilakukan anaknya karena merasa piagam-piagam tersebut tidak berlaku lagi dengan kondisi saat ini. Piagam-piagam tersebut merupakan berbagai kejuaraan seni dan agama yang diikuti dan beberapa menyabet juara satu tingkat Kabupaten Pekalongan.<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>', 'ID001');
...
('121212', 'IMG-20180116-WA0003.jpg', 'nurkhusniyah', 'P', 'pekalongan', '2017-11-14', 'Pekalongan', 2017),
('123111', 'IMG-20180402-WA0005.jpg', 'Reza syarif H', 'L', 'Pekalongan', '2017-11-03', 'Pekalongan', 2016);
...
(2, '20180407_093657.jpg'),
(4, 'IMG_20180512_141924.jpg');
...
('ID006', 'mimin', '21232f297a57a5a743894a0e4a801fc3');
